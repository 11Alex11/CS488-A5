...
PROJECTS := cs488-framework imgui lodepng SOIL
...
SOIL: 
	@echo "==== Building SOIL ($(config)) ===="
	@${MAKE} --no-print-directory -C build -f SOIL.make
...
clean:
	...
	@${MAKE} --no-print-directory -C build -f SOIL.make clean
